...
class ConexaobdController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        if ($contador > 0) {
            return response()->json([
                ...
                'data' => $registros,
                'total' => $contador
            ], 200); //Retorna HHTP 200 (OK) com os dados e as contagens
        } else {
            return response()->json([
                'success' => false,
     ...
     */
        ...
        if ($registros) {
            ...
            ], 500); //Retorna HTTP 500 (INternal Server Error) se ocadastro falahar
        }
    }
        ...
        public function show($id)
        {
            ...
            // Verificando se o produto foi ecnotrado
            if ($registros) {
                return response()->json([
                    'success' => true,
        ...
        public function update(Request $request, string $id)
    {
        ...
        if ($registrosBanco->save()) {
            return response()->json([
                ...
                'data' => $registrosBanco       
            ], 200); //Retorna HTTP 200 se atualização for bem sucedida
        } else {
            return response()->json([
                'success' => false,
